...
# Y nr total pkt
with open('../pre-processing/1-pre_filt_tamanho_total_pkt.txt', 'r') as datafile:
    plotting = csv.reader(datafile)
    for ROWS in plotting:
...
# Y nr total pkt 
with open('../pre-processing/2-pre_filt_tamanho_total_pkt.txt', 'r') as datafile:
    plotting = csv.reader(datafile)
...
# Y nr total pkt 
with open('../pre-processing/3-pre_filt_tamanho_total_pkt.txt', 'r') as datafile:
    plotting = csv.reader(datafile)
